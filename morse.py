...
class MorseCodeTranslator:
    ...
    def translate_morse(self, morse, strict=True):
        ...
        if morse == "":
            return "You must provide a string of morse code to translate"
        ...
        #rstrip() removes spaces from the end of the string.
    ...
    def translate_text(self, text):
        ...
        if text == "":
            return "You must provide a text string to translate"
